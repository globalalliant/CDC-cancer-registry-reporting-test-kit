  ...
  module HDEAV100
    class DiagnosticReportLabMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        associated with the [US Core DiagnosticReport Profile for Laboratory Results Reporting profile](http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-lab|6.1.0)
