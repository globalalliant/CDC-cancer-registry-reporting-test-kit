...
module CancerRegistryReportingTestKit
  class EHRTNMDistantMetastasesCategoryTests < Inferno::TestGroup
    title 'mCODE TNM Distant Metastases Category'
    description %(
      # Background
      The mCODE TNM Distant Metastases Category group verifies that the system under test is
      able to provide correct responses for TNM Distant Metastases Category Observation queries. These queries
      return resources conforming to the [mCODE TNM Distant Metastases Category Profile](https://hl7.org/fhir/us/mcode/STU3/StructureDefinition-mcode-tnm-distant-metastases-category.html)
      ...
      **TNM Distant Metastases Category code** inputs as provided by the tester.
    ...
    id :ccrr_ehr_tnm_distant_metastases_category
    run_as_group
    ...
    test from: :ccrr_tnm_distant_metastases_category_search_test
    test from: :ccrr_tnm_distant_metastases_category_validation_test
    test from: :ccrr_tnm_distant_metastases_category_must_support_test
  end
end
